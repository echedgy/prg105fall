...
variable_file = open('states.txt' 'r')
...
state_capitals.write("Hawaii, Honolulu\n")
state_capitals.write("Delaware, Dover\n")
state_capitals.write("Indiana, Indianapolis\n")
...
for count in range(1, books + 1):
    print('Enter in book data')
    book = input("Please enter the book's table and author: ")
# 3) Close the file
books_file.close()
# TODO 6.4 Exceptions
